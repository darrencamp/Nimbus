...
{
    internal class AzureServiceBusWithPartitionedQueues : CompositeScenario, IConfigurationScenario<TransportConfiguration>
    {
        private readonly IConfigurationScenario<LargeMessageStorageConfiguration> _largeMessageScenario;

        public AzureServiceBusWithPartitionedQueues(IConfigurationScenario<LargeMessageStorageConfiguration> largeMessageScenario)
